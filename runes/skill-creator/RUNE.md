...
Creates new AI agent skills following the Agent Skills spec. Use when the user asks to create a new skill, add agent instructions, or document patterns for AI.
